...
public class AllDayDayView extends AllDayViewBase {
    ...
    @Override // com.sonymobile.calendar.AllDayViewBase
    protected boolean showFullEventText() {
        return true;
    }

    public AllDayDayView(Context context, AttributeSet attributeSet) {
