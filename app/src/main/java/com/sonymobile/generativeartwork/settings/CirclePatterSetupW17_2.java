...
public class CirclePatterSetupW17_2 extends LayerSettings {
    public CirclePatterSetupW17_2(Context context) {
        ...
        add(LayerSettings.Item.LetterXOffset, Float.valueOf(-0.1f));
        add(LayerSettings.Item.LetterYOffset, Float.valueOf(0.1f));
        add(LayerSettings.Item.LetterScale, Float.valueOf(1.0f));
